...
public final class WebCommonResourceInitializer implements IInitializer {
    ...
    public void init(Application application) {
        ...
        sharedResources.add(STYLE_RESOURCE_NAME, new CssPackageResource(getClass(), STYLE_RELATIVE_PATH, null, null, null));
        sharedResources.add(COMMON_RESOURCE_NAME, new JavaScriptPackageResource(getClass(), COMMON_RELATIVE_PATH, null, null, null));
        sharedResources.add(IE_SELECT_FIX_RESOURCE_NAME, new JavaScriptPackageResource(getClass(), IE_SELECT_FIX_RELATIVE_PATH, null, null, null));
        sharedResources.add(HIGHLIHT_RESOURCE_NAME, new JavaScriptPackageResource(getClass(), HIGHLIGHT_RELATIVE_PATH, null, null, null));
        sharedResources.add(SCROLL_RESOURCE_NAME, new JavaScriptPackageResource(getClass(), SCROLL_RELATIVE_PATH, null, null, null));
        sharedResources.add(PLACEHOLDER_RESOURCE_NAME, new JavaScriptPackageResource(getClass(), PLACEHOLDER_RELATIVE_PATH, null, null, null));
    }
    ...
    private static ResourceReference newResourceReference(String resourceName) {
        return new PackageResourceReference(resourceName);
    }
}
